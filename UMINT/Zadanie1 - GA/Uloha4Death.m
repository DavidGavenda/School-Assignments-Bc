...
for i=1:PocetGeneracii
    ...
    for j=1:PocetJednotlivcov
        ...
        if x1+x2+x3+x4+x5 >=10000000 %death penalty
            zisk(j)= zisk(j) + 100000000;
        end
 
        if x1+x2 >=2500000 %death penalty
            zisk(j)= zisk(j) + 100000000; 
        end
 
        if -x4+x5 >=0 %death penalty
            zisk(j)= zisk(j) + 100000000; 
        end
 
        if 0.5*(-x1-x2+x3+x4-x5) >=0 %death penalty
            zisk(j)= zisk(j) + 100000000; 
        end
    end
