...
void helfer(int arr[], int n, int i);
void otoc(int arr[], int n);
...
void siftUp(int data[], const size_t addIndex)
{
	...
	if (addIndex && data[parent] > data[addIndex]) {
...
int main() {
	...
	int data[11] = { 7, 2, 1, 2, 8, 5, 3, 4, 2, 2, 6 };
	heapSort(data, 11);
	vypis(data, 11);
	return 0;
}